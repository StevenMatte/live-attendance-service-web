                ...
                <div 
                    ...
                    <div className="pt-2 pb-4">
                        <span className="flex flex-row text-center justify-center items-center gap-1">
                            <RiLoginBoxLine className="text-center lg:text-4xl text-3xl tracking-tight text-lime-700 mt-2"/>
                            <p className="text-center lg:text-xl text-lg font-extrabold tracking-tight text-gray-800 mt-2">Clock In</p>
                        </span>
                ...
                <div className="flex flex-grow justify-center items-center">
                    <div className="w-1/2 ">
                        <button
                            ...
                            type="submit"
                            className="flex w-full justify-center rounded-2xl bg-lime-500 px-3 py-3 text-md/6 font-semibold text-white hover:bg-lime-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                            >
